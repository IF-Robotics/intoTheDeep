...
//    public static final double startLeftX = -(2*(3 + 7/16) + 14.74/2);
    ...
    public static Pose2d highChamberEvRight = new Pose2d(18, -34, Rotation2d.fromDegrees(40));
    ...
    public static Pose2d wallEvPickUp = new Pose2d(38, -59.5, Rotation2d.fromDegrees(0));
