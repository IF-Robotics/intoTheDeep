...
//    public static Pose2d rightSideLeftSpike = new Pose2d(26, -37, Rotation2d.fromDegrees(-37));
    public static Pose2d rightSideMiddleSpike = new Pose2d(43, -36, Rotation2d.fromDegrees(-37));
    ...
    //wallPickUp
    public static Pose2d wallPickUp = new Pose2d(37, -58, Rotation2d.fromDegrees(180));
